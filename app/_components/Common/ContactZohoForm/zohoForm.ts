  ...
  <form id='webform6443913000000708004' name='WebToLeads6443913000000708004' accept-charset='UTF-8'>
    ...
    <style>
      ...
      .zcwf_lblLeft .zcwf_button {
        border: 1px solid rgba(var(--gray-800));
		border-radius: 100px;
		padding: 6px 12px;
		color: rgba(var(--gray-800));
		font-size: 18px;
		font-weight: 600;
		cursor: pointer;
    ...
    <div class='zcwf_row' style="display: flex;flex-direction: column;gap: 4px;">
      ...
      <div class='zcwf_col_fld'>
        <input type='text' id='Mobile' aria-required='true' aria-label='Mobile' name='Mobile' aria-valuemax='30' maxlength='30'></input>
        <div class='zcwf_col_help'></div>
      </div>
    </div>
    <div class='zcwf_row' style="display: flex;flex-direction: column;gap: 4px;">
    ...
    <script>
      ...
      function checkMandatory6443913000000708004() {
        ...
        if (!validateEmail6443913000000708004()) {
          return false;
        }
